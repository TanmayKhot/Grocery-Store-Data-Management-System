...
# If the file name is passed then it is used to move error files into error bucket
# If the file name is not passed then it is used to transfer the successfully processed files into processed_data bucket
